...
window.pcs.messageBox = (function () {
  ...
  function show(msg, callback, modal = false, buttonArray = ['ok']) {
    ...
    // const firstInput = get('one');
    // const secondInput = get('two');
    // const thirdInput = get('three');
    
    // const newButtons = {
    //   one: firstInput.value,
    //   two: secondInput.value,
    //   three: thirdInput.value
    // };
